...
　 
 ...
 const uploadItems: Array<{
   ...
   { key: "imgPlan", label: "間取り図" },
    { key: "imgSub1", label: "リビング（左）" },
    { key: "imgSub2", label: "キッチン（左）" },
          ...
          <div className="rounded-2xl border border-zinc-200 bg-white p-5 shadow-sm md:p-6">
            ...
            <div className={`mt-6 rounded-lg border p-4 transition ${highlightSection === "contact" ? "border-emerald-500 bg-emerald-50/70 ring-2 ring-emerald-200" : "border-zinc-200 bg-zinc-50"}`}>
              ...
              <div className="grid gap-3 md:grid-cols-2">
                ...
                <div><FieldLabel required>E-mail</FieldLabel><Input required type="email" value={contactInfo.companyEmail} onChange={(e) => updateContact("companyEmail", e.target.value)} /></div>
            ...
            <div className="mt-8 flex flex-wrap items-center justify-between gap-3">
              ...
              <div className="flex gap-2">
                 <button type="button" onClick={onTemporarySave} className="rounded-md bg-emerald-500 px-5 py-2.5 text-sm font-semibold text-white">保存</button>
